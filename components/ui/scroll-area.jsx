  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="h-full w-full rounded-[inherit] outline-none overflow-auto"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="relative flex-1 rounded-full bg-accent hover:bg-accent/80 dark:bg-slate-800"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  );
}
